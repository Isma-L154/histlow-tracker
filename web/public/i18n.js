...
export const DICTIONARY = {
  en: {
    ...
    "error.405": "That request method is not supported here.",
    "error.500": "Something went wrong. Try again in a moment.",
    "error.noRoute": "There is nothing at that address.",
    ...
    "time.tooMany": "Too many completion-time lookups. Wait a minute and try again.",
    "howto.tooMany": "Too many how-to lookups. Wait a minute and try again.",
  ...
  es: {
    ...
    "error.405": "Ese método de petición no se admite aquí.",
    "error.500": "Algo ha fallado. Prueba otra vez en un momento.",
    "error.noRoute": "No hay nada en esa dirección.",
    ...
    "upcoming.title": "Los más esperados",
    "upcoming.days": "{days} días",
    "upcoming.tomorrow": "mañana",
    "upcoming.today": "hoy",
    "time.label": "Tiempo para el 100%",
    "time.hours": "unas {hours} horas",
    "time.underAnHour": "menos de una hora",
    ...
    "time.tooMany": "Demasiadas consultas de duración. Espera un minuto y vuelve a intentarlo.",
    "howto.tooMany": "Demasiadas consultas de guía. Espera un minuto y vuelve a intentarlo.",
